...
<%@ page import="crjd.model.admin.system.user.UserInfoVO,crjd.common.SessionContainer,crjd.common.PageOut" %>
<html:html>
<head>
  <html:base/>
<title>操作员信息修改</title>
...
<%
UserInfoVO userInfoVO = (UserInfoVO)request.getAttribute("object");
if( userInfoVO == null){
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="wudi">&nbsp;您现在的位置：系统维护 → 用户维护 → 操作员信息修改</td>
  </tr>
</table>
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
...
<html:form action="/userInfoAction.do" method="post" focus="userInfoVO.userName">
...
<table width="70%"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#DEE5EF" style="border-collapse: collapse">
      <tr>
        <td height="24" colspan="3" class="ziti" background="<%=request.getContextPath()%>/images/di.jpg"><div align="center"><span class="header">操作员信息修改</span></div></td>
      </tr>

      <html:hidden property="userInfoVO.userRowId" value="<%=userInfoVO.getUserRowId()%>"/>

      <tr>
        <td width="30%"  height="22" bgcolor="#ECFBFF" class="ziti">&nbsp;操作员ID</td>
        <td colspan="2" bgcolor="#FFFFEC">&nbsp;
          <%=userInfoVO.getUserId()%>
          <html:hidden property="userInfoVO.userId" value="<%=userInfoVO.getUserId()%>"/>
          <span class="style1"></span>&nbsp;</td>
      </tr>
      <tr>
        <td height="22" bgcolor="#ECFBFF" class="ziti">&nbsp;操作员姓名</td>
        <td colspan="2" bgcolor="#FFFFEC">&nbsp;
          <html:text styleClass="shuru" maxlength="20" property="userInfoVO.userName" value="<%=userInfoVO.getUserName()%>"/>
          <span class="style1">*</span></td>
      </tr>
      <tr>
        <td height="22" bgcolor="#ECFBFF" class="ziti">&nbsp;密码</td>
        <td colspan="2" bgcolor="#FFFFEC">&nbsp;
          <html:password styleClass="shuru" maxlength="10" property="userInfoVO.userPassword" value="<%=userInfoVO.getUserPassword()%>"/>
          <span class="style1"></span></td>
      </tr>
      <tr>
        <td height="22" bgcolor="#ECFBFF" class="ziti">&nbsp;确认密码</td>
        <td colspan="2" bgcolor="#FFFFEC">&nbsp;
          <input type="password" class="shuru" maxlength="10" name="userPassword2" value="<%=PageOut.Print(userInfoVO.getUserPassword()) %>"/>
          <span class="style1"></span></td>
      </tr>
      <tr>
        <td height="22" bgcolor="#ECFBFF" class="ziti">&nbsp;所在机构</td>
        <td colspan="2" bgcolor="#FFFFEC">&nbsp;
          <user-tag:department property="userInfoVO.userDepId" upDepartmentId="" value="<%=userInfoVO.getUserDepId()%>" styleClass="shuru" />
          <span class="style1">*</span></td>
      </tr>
      <tr>
        <td height="5" bgcolor="#ECFBFF" class="ziti">&nbsp;电子邮件</td>
        <td width="38%" class="right" bgcolor="#FFFFEC">&nbsp;
          <html:text styleClass="shuru" maxlength="50" property="userInfoVO.userEmail" value="<%=userInfoVO.getUserEmail()%>"/>
          <span class="style1"></span></td>
      ...
      <tr>
        ...
        <td width="38%" class="right" bgcolor="#FFFFEC">&nbsp;
          <html:select styleClass="shuru" property="userInfoVO.userState" value="<%=userInfoVO.getUserState()%>" style="width:100pt ">
      ...
      <tr>
        ...
        <td class="right" bgcolor="#FFFFEC">&nbsp;
          <html:textarea cols="60" styleClass="shuru" rows="3" property="userInfoVO.userRemark" value="<%=userInfoVO.getUserRemark()%>" onkeyup ="javascript:checkUserRemark();" ></html:textarea></td>
        <td width="33%" class="left" bgcolor="#FFFFEC">&nbsp;&nbsp; 限字 150</td>
      </tr>
      <tr bgcolor="#ECFBFF">
        <td height="27" colspan="3">&nbsp;<span class="ziti">加 <span class="style1">*</span> 的内容不能为空</span></td>
      </tr>
      <tr >
