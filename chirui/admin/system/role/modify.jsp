...
<%
RoleInfoVO roleInfoVO = (RoleInfoVO)request.getAttribute("object");
if( roleInfoVO == null){
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="wudi">&nbsp;您现在的位置：系统维护 →角色维护 → 角色信息修改</td>
  </tr>
</table>
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
...
<input type="hidden" name="actionType" value="5"/>
 <html:hidden property="roleInfoVO.roleRowId" value="<%=roleInfoVO.getRoleRowId()%>"/>
  <table width="70%"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#DEE5EF"
  style="border-collapse: collapse">
      <tr>
        <td height="24" colspan="3" class="ziti" background="<%=request.getContextPath()%>/images/di.jpg"><div align="center"><span class="header">角色信息维护</span></div></td>
      </tr>
      <tr>
        <td width="25%"  height="22" bgcolor="#ECFBFF" class="ziti">&nbsp;角色编码</td>
        <td colspan="2" bgcolor="#FFFFEC">&nbsp;
          <html:text styleClass="shuru" maxlength="8" property="roleInfoVO.roleId" value="<%=roleInfoVO.getRoleId()%>" onkeyup ="javascript:checkRoleId();"/>
          <span class="style1">*</span>&nbsp;</td>
      </tr>
      <tr>
        <td height="22" bgcolor="#ECFBFF" class="ziti">&nbsp;角色名称</td>
        <td colspan="2" bgcolor="#FFFFEC">&nbsp;
          <html:text styleClass="shuru" maxlength="20" property="roleInfoVO.roleName" value="<%=roleInfoVO.getRoleName()%>"/>
          <span class="style1">*</span></td>
      </tr>
      <tr>
        <td height="5" bgcolor="#ECFBFF" class="ziti">&nbsp;备注</td>
        <td class="right" bgcolor="#FFFFEC">&nbsp;
          <html:textarea cols="60" styleClass="shuru" rows="3" property="roleInfoVO.roleRemark" value="<%=roleInfoVO.getRoleRemark()%>" onkeyup ="javascript:checkRoleRemark();"></html:textarea></td>
