...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="wudi">&nbsp;您现在的位置：系统维护 → 机构管理 → 机构信息修改</td>
  </tr>
</table>
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
...
<table width="70%"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#DEE5EF" style="border-collapse: collapse">
      <tr>
        <td height="24" colspan="3" class="ziti" background="<%=request.getContextPath()%>/images/di.jpg"><div align="center"><span class="header">机构信息修改</span></div></td>
      </tr>
      ...
      <tr >
        <td height="24" colspan="3" background="<%=request.getContextPath()%>/images/di.jpg"><div align="center">
            <input name="Submit" type="submit" class="ziti" value="确定" onclick="return oncheck();">
            &nbsp;
            <input name="Submit3" type="button" class="ziti" value="取消" onclick="return RZback();">
        </div></td>
      </tr>
</table>
