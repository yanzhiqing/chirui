...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="wudi">&nbsp;您现在的位置：系统维护 → 菜单维护 → 菜单信息添加</td>
  </tr>
</table>
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
...
<html:form action="/menuAction.do" method="post">
  ...
  <table width="70%"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#DEE5EF" style="border-collapse: collapse">
      <tr>
        <td height="24" colspan="3" class="ziti" background="<%=request.getContextPath()%>/images/di.jpg"><div align="center"><span class="header">菜单信息添加</span></div></td>
      </tr>
	  <tr>
        <td  height="22" bgcolor="#ECFBFF" class="ziti">&nbsp;菜单模块</td>
        <td colspan="2" bgcolor="#FFFFEC">&nbsp;&nbsp;<html:select property="menuVO.menuCol1" value="" styleClass="shuru" style="width:100pt">
	  ...
	  <tr>
        ...
        <td colspan="2" bgcolor="#FFFFEC">&nbsp;&nbsp;<user-tag:menupart property="menuVO.menuUpId" value="" styleClass="shuru" style="width:100pt"/>
          <!--html:text styleClass="shuru" maxlength="20" property="menuVO.menuUpId" value=""/-->
          <span class="style1">*</span></td>
      </tr>
	  <tr>
        <td  height="22" bgcolor="#ECFBFF"  width="40%" class="ziti">&nbsp;菜单编码</td>
        <td colspan="2" bgcolor="#FFFFEC">&nbsp;
          <html:text styleClass="shuru" property="menuVO.menuId" value=""  maxlength="8" onkeyup ="javascript:checkMenuId();"/>
          <span class="style1">*</span>&nbsp;</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td colspan="2" bgcolor="#FFFFEC">&nbsp;
          <html:text styleClass="shuru" style="width:286pt" property="menuVO.menuUrl" value=""  maxlength="200"/>
        </td>
      </tr>
      <tr>
        <td height="5" bgcolor="#ECFBFF" class="ziti">&nbsp;备注</td>
        <td class="right" bgcolor="#FFFFEC">&nbsp;
          <html:textarea cols="60" styleClass="shuru" rows="3" property="menuVO.menuRemark" value=""  onkeyup ="javascript:checkMenuRemark();"></html:textarea></td>
