...
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td class="wudi">&nbsp;您现在的位置：系统维护 → 菜单维护 → 菜单信息添加 →菜单操作添加</td>
  </tr>
</table>
<table width="100%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
...
<html:form action="/menuPopeAction.do" method="post" focus="menuPopeVO.popeName">

  <input type="hidden" name="actionType" value="1"/>
  <input type="hidden" name="menuPopeVO.menuId" value="<%=menuid%>"/>
  <table width="70%"  border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#DEE5EF" style="border-collapse: collapse">
      <tr>
        <td height="24" colspan="3" class="ziti" background="<%=request.getContextPath()%>/images/di.jpg"><div align="center"><span class="header">菜单操作信息添加</span></div></td>
      </tr>
      <tr>
        <td width="30%" height="22" bgcolor="#ECFBFF" class="ziti" width="40%">&nbsp;菜单操作名称</td>
        <td colspan="2" bgcolor="#FFFFEC">&nbsp;
          <html:text styleClass="shuru" maxlength="20" size="30" property="menuPopeVO.popeName" value=""  onkeyup ="javascript:checkPopeName();"/>
          <span class="style1">*</span></td>
      </tr>
      <tr>
        <td  height="22" bgcolor="#ECFBFF" class="ziti">&nbsp;菜单操作URL</td>
        <td colspan="2" bgcolor="#FFFFEC">&nbsp;
          <html:text styleClass="shuru" maxlength="100" style="width:286pt" property="menuPopeVO.popeUrl" value=""/>
          <span class="style1">*</span>&nbsp;</td>
      </tr>
      <tr>
        <td height="5" bgcolor="#ECFBFF" class="ziti">&nbsp;备注</td>
        <td class="right" bgcolor="#FFFFEC">&nbsp;
          <html:textarea cols="60" styleClass="shuru" rows="3" property="menuPopeVO.col1" value=""  onkeyup ="javascript:checkcCol1();"></html:textarea></td>
