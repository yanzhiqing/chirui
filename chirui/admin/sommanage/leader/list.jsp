		...
		<c:forEach items="${list}" var="object" varStatus="index" >
				...
				<tbody class="${ (index.count%2 != 0) ? 'tb1' : 'tb2' }">
					<tr bgcolor="#E2FAFE">
						...
						<td>
							<div align="center">
								<c:out value="${object.leadername}"/>
							</div>
						</td>
						<td>
							<div align="center">
								<c:out value="${object.leaderpower}"/>
							</div>
						</td>								
						...
						<td align="center">
							<a href="<%=request.getContextPath()%>/leaderAction.do?actionType=3&key=${object.id}" >修改</a>	&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="<%=request.getContextPath()%>/leaderAction.do?actionType=4&key=${object.id}" >详细</a>
				...
				<table width="15%" border="0">
					<tr>
						...
						<td valign="middle" width="30" id="RZtjczt" style="">
							<input type="button" class="ziti" value="添加领导" onClick="return add();"/>
						</td>
