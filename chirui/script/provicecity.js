...
new Array("110105","朝阳"), 
new Array("110106","丰台"), 
new Array("110107","石景山"), 
new Array("110108","海淀"), 
new Array("110109","门头沟"), 
new Array("110111","房山"), 
new Array("110112","通州"), 
new Array("110113","顺义"), 
new Array("110114","昌平"), 
...
new Array("500102","涪陵"),
new Array("500103","渝中"),
new Array("500104","大渡口"),
new Array("500105","江北"),
new Array("500106","沙坪坝"),
new Array("500107","九龙坡"),
new Array("500108","南岸"),
new Array("500109","北碚"),
new Array("500110","万盛"),
new Array("500111","双桥"),
...
{ 
	selProvince.options[0]=new Option("--不限--",""); 
...
{ 
	...
	||ProvinceCode=="810000"||ProvinceCode=="820000"||ProvinceCode=="500000") 
		...
		selCity.options[0]=new Option("--不限--",""); 
		count=1;
	}
...
{ 
	...
	||ProvinceCode=="810000"||ProvinceCode=="820000"||ProvinceCode=="500000") 
		...
		if(CityCode=="000000"){
			selCity.options[0]=new Option("请选择",CityCode);               
		}
		count=1;
	}        
	for(i=0;i<Citys.length;i++) 
...
/* 修改Province_onchange()和InitCitySelect（）两个方法
　蒋华涛
　2009-1-6
