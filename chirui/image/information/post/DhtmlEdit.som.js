...
{	
	...
	if (Dvbbs_bIsIE5){
		...
		IframeID.document.write ('			parent.document.schoolfellowForm.Submit.disabled=true;');
		IframeID.document.write ('			parent.document.schoolfellowForm.submit();}');
		IframeID.document.write ('		}');
		IframeID.document.write ('	}');
...
function ctlent(){
	...
	if (document.all)
	{
		...
		Dvbbs_CopyData('Body')
		Checkdata()
		if (ischeck==true){this.document.schoolfellowForm.submit();}
		}
	}
}
