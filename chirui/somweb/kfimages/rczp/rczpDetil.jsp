...
<%
	String new_id = (String)request.getParameter("id");
	//System.out.println("new_id ==" + new_id);
	GetNews newInfo= new GetNews(application);
	Hashtable news = newInfo.getNewsInfo(new_id);
%>
<head>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="5"><img src="<%=request.getContextPath()%>/images/home/arr.gif" width="5" height="5" /></td>
    <td width="10"></td>
    <td align="left" class="menu"><a  href="<%=request.getContextPath()%>/somweb/rczp/rcpy.jsp">人才培养</a></td>
  </tr>
</table>
</td>
  </tr>
...
<a href="<%=request.getContextPath()%>/somweb/lxwm/lxwm.jsp">
    ...
    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="5"></td>
            <td height="18" align="left" ><span style="font-weight:bold;  ">当前位置：</span><a href="#">首页</a> > <a href="#">人才招聘</a> > <a href="#">人才招聘</a></td>
          </tr>
        </table></td>
      </tr>
      <tr>
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td ><h2><%=news.get("TITLE")%></h2></td>
        </tr>
        <tr>
          <td  style="padding:20px"><%=news.get("CONTENT")%></td>
        </tr>
      </table></td>
    <td width="20"></td>
  </tr>
