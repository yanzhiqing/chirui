...
ArrayList listInfo = newInfo.getMainNews("102");
%>
      ...
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="5"></td>
            <td height="18" align="left" ><span style="font-weight:bold;  ">当前位置：</span><a href="#">首页</a> > <a href="#">资讯中心</a> > <a href="#">行业动态</a></td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
%>
        <tr>
          ...
          <td  width="580" align="left" height="25"><a href="<%=request.getContextPath()%>/somweb/zxzx/newsDetil.jsp?id=<%=ht.get("ID")%>&flag=2"><%=ht.get("TITLE")%></a></td>
